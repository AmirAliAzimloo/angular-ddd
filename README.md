...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/S16z8AzSFj)
...
```sh
npx nx generate @nx/angular:library libs/ui-core --importPath=@angular-ddd/ui-core
```
